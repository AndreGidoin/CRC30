 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmeXWa3gec9ALMAbB6WmEUcmTeC9nuUiumQBaBAD2hpttg"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      number: 6,
      textnumber: 'six',
      ArticleName: ' I should be supported to live and grow.',
      ArticleContent: "Children and young people should be able to grow up in conditions that don't impact negatively on their physical and mental wellbeing. It says the government should make sure they can live in these conditions in order that they can develop.",
      artistName:'@KasperGiraffe',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
