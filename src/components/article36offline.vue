 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmfVWV1RZnn7Jab6SzuVBed5nFpsZ2iuH7fExtBUATamJG/Article_Placeholder_Blue.gif"/>
      </div>
      <div class="worthInfo">
...
export default {
  name: "articl36offline",
  mounted() {
  },
  data() {
    return {
      number: 36,
      textnumber: 'thirtysix',
      ArticleName: 'N/A',
      ArticleContent: "N/A",
      artistName:'Fredrik Melby',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
