 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmXgBYJhwQQ51UtsLUz13PsUVVC5ctSFhsbiUK9RyxmbmN"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      number: 5,
      textnumber: 'five',
      ArticleName: 'The Government should respect the right of my family to help me know about my rights.',
      ArticleContent: 'Governments must respect the rights and responsibilities of parents and carers to provide guidance and direction to their child as they grow up, so that they fully enjoy their rights...',
      artistName:'Alberto & Sebastiano Lot',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
