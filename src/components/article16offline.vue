 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmeBLXA5zB4s3F7zpczbWyH5sVWL41Vuw5kAFwod1f1Lfm"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      number: 16,
      textnumber: 'sixteen',
      ArticleName: 'I have the right to keep some things private.',
      ArticleContent: "Every child has the right to privacy. The law should protect the child’s private, family and home life, including protecting children from unlawful attacks that harm their reputation...",
      artistName:'GMUNK',
      flipped:false,
      tricked: false,
      visible: false,
