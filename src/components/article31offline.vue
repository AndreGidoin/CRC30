 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <video autoplay muted loop class="videoFrame"  v-bind:class="{ 'videoFrameBigger' : flipped }">
        <source src="https://gateway.pinata.cloud/ipfs/QmYF3XUhkzWXW9Re9ewvh4qjdRR3SYBPkCReptutBZaqJp" type="video/mp4">
      </video>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      number: 31,
      textnumber: 'thirtyone',
      ArticleName: 'I have a right to relax and play.',
      ArticleContent: "Every child has the right to relax, play and take part in a wide range of cultural and artistic activities...",
      artistName:'Verena Michelitsch',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
