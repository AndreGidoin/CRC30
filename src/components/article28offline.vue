 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmfVWV1RZnn7Jab6SzuVBed5nFpsZ2iuH7fExtBUATamJG/Article_Placeholder_Red.gif"/>
      </div>
      <div class="worthInfo">
...
export default {
  name: "articl28offline",
  mounted() {
  },
  data() {
    return {
      number: 28,
      textnumber: 'twentyeight',
      ArticleName: 'N/A',
      ArticleContent: "N/A",
      artistName:'Julie Wilkinson',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
