 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmapEva4cDJBcN16X19qD2ua51tV6kt81WUzWGgoYnjofY"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      ...
      ArticleName: 'I have the right to get information in lots of ways, so long as it’s safe.',
      ArticleContent: "Children and young people should be able to access information, particularly from the media. They should be able to get information from many places— from their country and beyond...",
      artistName:'Sasha Lend',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
