 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmW23rb2iZ3w4nP9qqzzkXX1YPNqEZcQMQKBkzKWnXSWw2"/>
      </div>
      <div class="worthInfo">
...
export default {
  name: "articl24offline",
  mounted() {
  },
  data() {
    return {
      number: 24,
      textnumber: 'twentyfour',
      ArticleName: 'I have the right to good quality health care, to clean water and good food.',
      ArticleContent: "Every child has the right to the best possible health. Governments must provide good quality health care, clean water, nutritious food, and a clean environment and education on health and well-being so that children can stay healthy...",
      artistName:'Malte Gruhl',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
