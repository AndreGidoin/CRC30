 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmeCabgzLCmAo5TKoQ7SoqXcgn7vqcCtUyaonfnvAtwGsZ"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      ...
      ArticleName: 'I have the right to an education which develops my personality, respect for others’ rights and the environment.',
      ArticleContent: "Education must develop every child’s personality, talents and abilities to the full. It must encourage the child’s respect for human rights, as well as respect for their parents, their own and other cultures, and the environment...",
      artistName:'Line Vågsmyr',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
