...
export default {
  name: "article7",
  mounted() {
    console.log("dispatching getArticle7Instance");
    this.$store.dispatch("getArticle7Instance");
  ...
  methods: {
    ...
    ArticleName(event) {
      ...
      this.$store.state.article7Instance().conventionArticleName(
        {
          gas: 30000,
          from: this.$store.state.web3.coinbase
        },
    ...
    crcArticleNumber(event) {
      ...
      this.$store.state.article7Instance().conventionArticleNumber(
        {
          gas: 30000,
          from: this.$store.state.web3.coinbase
        },
    ...
    currentWorthOfArticle(event) {
      ...
      const theCurrentWorth = new Promise((resolve, reject) => {
        this.$store.state.article7Instance().currentWorth((error, result) => {
          if (error) {
    ...
    ipfsNewEvent(event) {
      ...
      const theIPFSHash = new Promise((resolve, reject) => {
        this.$store.state.article7Instance().ipfsImageHash((error, result) => {
          if (error) {
    ...
    ownerCount(event) {
      ...
      const promise1 = new Promise((resolve, reject) => {
        this.$store.state.article7Instance().owners((error, result) => {
          if (error) {
            console.log(err);
    ...
    ownerPromise(event) {
      ...
      const _ownerCount = new Promise((resolve, reject) => {
        this.$store.state.article7Instance().getUsersCount((error, result) => {
          if (error) {
            console.log(error);
          ...
          const getArray = new Promise((resolve, reject) => {
              ...
              for (let i = 0; i < result; i++) {
                  const ownernames = new Promise((resolve, reject) => {
                      this.$store.state.article7Instance().getUser(i, (error, result) => {
                          if (error) {
