 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmRaqqYMPwTnqD8X7G1kBmqnSKy7z2yHYLXjSpYD4p9ZjR"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      ...
      ArticleName: 'I have the right not to be punished in a cruel or hurtful way.',
      ArticleContent: "Children must not be tortured, sentenced to the death penalty or suffer other cruel or degrading treatment or punishment...",
      artistName:'Makerie Studio & André Gidoin',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
