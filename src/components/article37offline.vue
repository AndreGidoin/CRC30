  ...
  <div class="root-container">
    ...
    <div class="flipcard" @click="flip">
      ...
      <div class="articleNumber">
            <p><span id="numerals">Article 37</span></p>
      </div>
    <!-- SHADOW CONTAINER -->
    ...
    <div class="Frontside" v-bind:class="{ 'reveal' : flipped }">
      ...
      <div class="theArtwork">
        ...
        <p class="ownerPlaqueSmall">Artwork by:</p>
          <p class="ownerPlaqueBig">Makerie Studio</p>
        </div>
          <!-- END Owner Info -->
    </div>
...
.noMetaMaskPlaceholder::after {
  content: "";
  background-image: url('https://gateway.pinata.cloud/ipfs/QmRaqqYMPwTnqD8X7G1kBmqnSKy7z2yHYLXjSpYD4p9ZjR');
  background-size: 100%;
  background-repeat: no-repeat;
  opacity: 0.3;
  top:66px;
