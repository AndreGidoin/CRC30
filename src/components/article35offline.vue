  ...
  <div class="root-container">
    ...
    <div class="flipcard" @click="flip">
      ...
      <div class="articleNumber">
            <p><span id="numerals">Article 35</span></p>
      </div>
    <!-- SHADOW CONTAINER -->
    ...
    <div class="Frontside" v-bind:class="{ 'reveal' : flipped }">
      ...
      <div class="theArtwork">
        ...
        <p class="ownerPlaqueSmall">Artwork by:</p>
          <p class="ownerPlaqueBig">Davide Parere</p>
        </div>
          <!-- END Owner Info -->
    </div>
...
.noMetaMaskPlaceholder::after {
  content: "";
  background-image: url('https://gateway.pinata.cloud/ipfs/QmbGn52Zmp2gj64sbmbDvPLqV9sfu5vj14UFgVz7YqnbpR');
  background-size: 100%;
  background-repeat: no-repeat;
  opacity: 0.3;
  top:66px;
