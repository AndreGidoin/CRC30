 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmaMKrzYnpGsYr8YJcAVPYTMvQ5biB2hNqmcNRm39BauWt"/>
      </div>
      <div class="worthInfo">
...
export default {
  name: "articl25offline",
  mounted() {
  },
  data() {
    return {
      number: 25,
      textnumber: 'twentyfive',
      ArticleName: 'If I am not living with my family, people should keep checking I am safe and happy.',
      ArticleContent: "If a child has been placed away from home for the purpose of care or protection (for example, with a foster family or in hospital), they have the right to a regular review of their treatment, the way they are cared for and their wider circumstances...",
      artistName:'Lucia Giacani',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
