 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmVq72Vb58tfjaSnno4ecVrbmJPVUqM749zDDs5i8VDiKQ"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      number: 12,
      textnumber: 'twelve',
      ArticleName: 'I have the right to be listened to, and taken seriously.',
      ArticleContent: "The opinion of a child and young person should be considered everywhere, including in their home, in their workplace and at school. This is true no matter how young a child or young person is, although the weight their opinion is given should change as they grow up and become more mature... ",
      artistName:'Sandra Freij & Jo McGuinness',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
