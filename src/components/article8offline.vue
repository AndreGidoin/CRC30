 ...
 <!-- Article Number -->
    ...
    <div class="ShadowContainer" v-bind:class="{ 'foldout' : flipped }" @click="flip">
      ...
      <div class="theArtwork">
          <img src="https://gateway.pinata.cloud/ipfs/QmaX2X52mHVZCdvfQg2fYQBkqTjhTB9ZDcbAhsAVLDo5ug"/>
      </div>
      <div class="worthInfo">
...
export default {
  ...
  data() {
    return {
      number: 8,
      textnumber: 'eight',
      ArticleName: 'You have the right to an identity.',
      ArticleContent: "Every child has the right to an identity. Governments must respect and protect that right, and prevent the child’s name, nationality or family relationships from being changed unlawfully...",
      artistName:'Brian Cattelle',
      flipped:false,
      tricked: false,
      visible: false,
      isMouseOver: false,
